...
import searchImg from '../../img/magnifier.svg'
import addGroupImg from '../../img/add-group-of-people.png'
import addUserImg from '../../img/add-user-button.png'
//config
...
class Chat extends React.Component {
    ...
    componentDidMount(){
        ...
        let socket = io.connect('http://' + config.serverUrl +':'+ config.serverPort, {reconnection: true});
        //receivers
        this.socket = socket
            //.emit('sayOnLine')
